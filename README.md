...
Cuando la terminal se carga, está lista para recibir comandos. Escribe `help` para ver la lista completa.

| Comando | Descripción |
| :--- | :--- |
| **`help`** | Muestra la lista de todos los comandos disponibles. |
| **`about`** | Muestra información detallada sobre Mónica. |
...
```bash
git clone https://github.com/YoungAlely/YoungTego.git
cd YoungTego
```
...
El proyecto se abrirá en tu navegador, generalmente en `http://localhost:5173/`.

-----

## 🤝 Contribución

¡Las contribuciones son bienvenidas\! Si tienes ideas para nuevos comandos, mejoras en la UX/UI (especialmente en móvil) o correcciones de errores:

1.  Haz un *Fork* del repositorio.
2.  Crea una nueva rama (`git checkout -b feature/MiMejora`).
3.  Commitea tus cambios.
4.  Abre un *Pull Request* claro y descriptivo.
